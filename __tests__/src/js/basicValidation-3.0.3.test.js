...
describe('Spectral Validation Rules', () => {
  ...
  test('should fail validation for OpenAPI 3.0.3', async () => {
    ...
    const expectedResults = [
      ...
      ['oas3-schema', Severity.Error, '"200" property must have required property "description".', '/paths/~1invalid-examples/get/responses/200'],
      ...
      ['operation-operationId-unique', Severity.Error, 'Every operation must have unique "operationId".', '/paths/~1path~1{usedButNotDeclared}~1{declaredButUnused}/get/operationId'],
      ...
      ['path-params', Severity.Error, 'Operation must define parameter "{q}" as expected by path "/query{?q}".', '/paths/~1query{?q}/get'],
      ['path-params', Severity.Error, 'Operation must define parameter "{usedButNotDeclared}" as expected by path "/path/{usedButNotDeclared}/{declaredButUnused}".', '/paths/~1path~1{usedButNotDeclared}~1{declaredButUnused}/get'],
      ...
      ['oas3-valid-media-example', Severity.Warning, '"value" property type must be number', '/paths/~1invalid-examples/get/responses/200/content/application~1json/examples/badMedia/value'],
      ...
      ['operation-description', Severity.Warning, 'Operation "description" must be present and non-empty string.', '/paths/~1path~1{usedButNotDeclared}~1{declaredButUnused}/get'],
      ...
      ['operation-operationId', Severity.Warning, 'Operation must have "operationId".', '/paths/~1invalid-examples/get'],
